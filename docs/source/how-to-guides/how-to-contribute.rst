...
.. _bug: https://github.com/rlaneyjr/rs-golf/issues

Fix Bugs
~~~~~~~~

Look through RS Golf GitHub issues_ for bugs.
...
Look through RS Golf GitHub issues_ for features.
...
RS Golf strives to have excellent documentation for several reasons:
...
RS Golf provides the four pillars Tutorials, How-to, Reference and
...
RS Golf uses Sphinx to document the API.  Class's, modules, or
...
an `Issue <https://github.com/rlaneyjr/rs-golf/issues>`_.
...
Here's how to set up `rs-golf` for local development. We have
...
2. From your GitHub account, fork the `rs-golf` repository.
...
.. note::
    ...
    RS Golf uses python-semantic-release.
...
.. _issues: https://github.com/rlaneyjr/rs-golf/issues
