...
RS Golf use restructured text (reST) and the `Sphinx` [#]_ documentation
build engine.
...
of `rs-golf.code-workspace` and without any extensions.
...
.. code-block:: json

    {
        ...
        "settings": {
            ...
            "liveServer.settings.multiRootWorkspaceName": "rs-golf",
            "[python]": {
